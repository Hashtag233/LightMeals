...
public class ModBlocks {
    ...
    public static final RegistryObject<LiquidBlock> CARAMEL_BLOCK = BLOCKS.register("caramel_block", () -> new CaramelFluidBlock(STILL, Block.Properties.of(Material.LAVA).noCollission().strength(100.0F).noDrops()));
}